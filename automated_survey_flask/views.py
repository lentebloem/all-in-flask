...
def get_attendance():
    responses = Question.query.get(2).answers.all()
    code = [res.content for res in responses if res.content not in rows]
    rows = [res.content for res in responses if res.content in rows]
